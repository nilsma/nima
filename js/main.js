/**
* A function to remove the displayed links of each projects link
* to the given projects showcase-page
*/
...
/**
* A function to find the given projects link to that projects
* showcase-page on click anywhere on that given projects encompassing
* .project-element. Also opens that link in a new tab
* @param element HTMLElement - the section.project HTML element
*/
